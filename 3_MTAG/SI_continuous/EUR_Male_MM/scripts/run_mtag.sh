...
# SI continuous EUR_Male_MM - Social Isolation traits (Male)
python /Users/mahmoudabdelmoneum/Desktop/MIT/Software/Research_Software/mtag/mtag.py \
        --sumstats ${BOLT_DIR}/mtag_results_continuous/EUR_Male/AbilityToConfide.Day_NoPCs.mtag.sumstats.txt,${BOLT_DIR}/mtag_results_continuous/EUR_Male/FreqSoc.Day_NoPCs.mtag.sumstats.txt,${BOLT_DIR}/mtag_results_continuous/EUR_Male/Loneliness.Day_NoPCs.mtag.sumstats.txt \
        --out ../results/SI_EUR_Male_MM_Output_continuous \
