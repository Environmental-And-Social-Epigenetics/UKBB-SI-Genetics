...
# SI continuous EUR_Female_MM - Social Isolation traits (Female)
python /Users/mahmoudabdelmoneum/Desktop/MIT/Software/Research_Software/mtag/mtag.py \
        --sumstats ${BOLT_DIR}/mtag_results_continuous/EUR_Female/AbilityToConfide.Day_NoPCs.mtag.sumstats.txt,${BOLT_DIR}/mtag_results_continuous/EUR_Female/FreqSoc.Day_NoPCs.mtag.sumstats.txt,${BOLT_DIR}/mtag_results_continuous/EUR_Female/Loneliness.Day_NoPCs.mtag.sumstats.txt \
        --out ../results/SI_EUR_Female_MM_Output_continuous \
