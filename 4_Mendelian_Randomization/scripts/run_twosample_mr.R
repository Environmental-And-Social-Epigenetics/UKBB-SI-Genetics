...
# Update these paths for your study
exposure_file <- "path/to/exposure_sumstats.txt"
outcome_file  <- "path/to/outcome_sumstats.txt"
out_prefix    <- "mr_results/loneliness_to_mri"
...
message("MR scaffold run complete.")
